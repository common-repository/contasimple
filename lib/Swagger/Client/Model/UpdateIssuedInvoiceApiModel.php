...
/**
 * UpdateIssuedInvoiceApiModel Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateIssuedInvoiceApiModel implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'UpdateIssuedInvoiceApiModel';
    ...
    protected static $swaggerTypes = [
        'target_entity' => '\Contasimple\Swagger\Client\Model\UpdateDocumentEntityApiModel',
    ...
    {
        $this->container['target_entity'] = isset($data['target_entity']) ? $data['target_entity'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['target_entity'] === null) {
            $invalid_properties[] = "'target_entity' can't be null";
        }
    ...
    /**
     * Gets target_entity
     * @return \Contasimple\Swagger\Client\Model\UpdateDocumentEntityApiModel
     */
    public function getTargetEntity()
    {
        return $this->container['target_entity'];
    }

    /**
     * Sets target_entity
     * @param \Contasimple\Swagger\Client\Model\UpdateDocumentEntityApiModel $target_entity The invoice target entity information
     * @return $this
     */
    public function setTargetEntity($target_entity)
    {
        $this->container['target_entity'] = $target_entity;
    ...
    public function setInvoiceClass($invoice_class)
    {
        ...
        if (($invoice_class > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $invoice_class when calling UpdateIssuedInvoiceApiModel., must be smaller than or equal to 2147483647.');
        }
        if (($invoice_class < 1)) {
            throw new \InvalidArgumentException('invalid value for $invoice_class when calling UpdateIssuedInvoiceApiModel., must be bigger than or equal to 1.');
        }
    ...
    public function setRetentionPercentage($retention_percentage)
    {
        ...
        if (!is_null($retention_percentage) && ($retention_percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $retention_percentage when calling UpdateIssuedInvoiceApiModel., must be smaller than or equal to 100.');
        }
        if (!is_null($retention_percentage) && ($retention_percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $retention_percentage when calling UpdateIssuedInvoiceApiModel., must be bigger than or equal to 0.');
        }
