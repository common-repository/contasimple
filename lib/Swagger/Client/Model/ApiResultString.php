...
/**
 * ApiResultString Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ApiResultString implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ApiResult[String]';
    ...
    /**
     * Sets data
     * @param string $data The API result
     * @return $this
     */
