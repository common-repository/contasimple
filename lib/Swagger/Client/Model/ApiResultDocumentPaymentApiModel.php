<?php
/**
 * ApiResultDocumentPaymentApiModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ApiResultDocumentPaymentApiModel Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ApiResultDocumentPaymentApiModel implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ApiResult[DocumentPaymentApiModel]';
    ...
    protected static $swaggerTypes = [
        'data' => '\Contasimple\Swagger\Client\Model\DocumentPaymentApiModel'
    ];
    ...
    /**
     * Sets data
     * @param \Contasimple\Swagger\Client\Model\DocumentPaymentApiModel $data The API result
     * @return $this
     */
